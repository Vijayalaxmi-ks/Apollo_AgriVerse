...
# ----------------------------------------------------------------------
# Resolve project root by stepping up 2 levels: team/vish/ -> team/ -> ROOT
...
repo_data = [
    [Paragraph("<b>File / Subfolder Path</b>", style_body), Paragraph("<b>Architectural Purpose & Technical Function</b>", style_body)],
...
t_repo.setStyle(TableStyle([
    ...
    ('TEXTCOLOR', (0, 0), (-1, 0), COLOR_PRIMARY_DARK),
...
db_schema_data = [
    [Paragraph("<b>Column Name</b>", style_body), Paragraph("<b>Data Type</b>", style_body), Paragraph("<b>Physical Interpretation & Unit</b>", style_body)],
...
pheno_data = [
    [Paragraph("<b>Phenology Stage</b>", style_body), Paragraph("<b>Day Range</b>", style_body), Paragraph("<b>Evap Multiplier</b>", style_body), Paragraph("<b>Moisture Threshold</b>", style_body), Paragraph("<b>Agronomic Rationale</b>", style_body)],
...
test_summary_data = [
    [Paragraph("<b>Test Name</b>", style_body), Paragraph("<b>Condition / Method</b>", style_body), Paragraph("<b>Observed Result</b>", style_body), Paragraph("<b>Status</b>", style_body)],
...
print(f"[SUCCESS] Apollo Comprehensive Manual PDF generated at: {PDF_OUTPUT_PATH}")